...
document.onreadystatechange = function () {
    console.log('document.onreadystatechange active = ', document.interactive)
    if (dictYiXue['\\debug'] != undefined) return;
    
    dictYiXue['\\debug'] = function (arg) {
        var gz = new ganzhi_1.GanZhi("戊午");
        return "\\text{i am ready  " + gz.NaYin + " }";
    };
    dictYiXue['\\nayin'] = index_1.DictYiXue['\\nayin'];
    dictYiXue['\\yao'] = index_1.DictYiXue['\\yao'];
    dictYiXue['\\paigua'] = index_1.DictYiXue['\\paigua'];
    dictYiXue['\\guayao'] = index_1.DictYiXue['\\guayao'];
    dictYiXue['\\gua64'] = index_1.DictYiXue['\\gua64'];
    dictYiXue['\\paibazi'] = index_1.DictYiXue['\\paibazi'];
    dictYiXue['\\bazi'] = index_1.DictYiXue['\\bazi'];
    dictYiXue['\\timegz'] = index_1.DictYiXue['\\timegz'];
    var fontsizeNumber = settingYixue["字体大小"] || 5;
    index_1.globalSetting["size"] = index_1.globalSetting["sizeDict"][fontsizeNumber.toString()];
    index_1.globalSetting["shuitu"] = settingYixue["水土共长生"] || index_1.globalSetting["shuitu"];
    index_1.globalSetting["huahe"] = settingYixue["华鹤八字正偏财"] || index_1.globalSetting["huahe"];
    index_1.globalSetting["shortname"] = settingYixue["开启短名"] || index_1.globalSetting["shortname"];
    ganzhi_1.ConfigGanZhi.ChangSheng = index_1.globalSetting["shuitu"];
    ganzhi_1.ConfigGanZhi.Huahe = index_1.globalSetting["huahe"];
    common_1.LatexHelp.COLOR = settingYixue["Katex"] == true ? "textcolor" : common_1.LatexHelp.COLOR;
